...
function FlatView({ rows, projectId, demo, onOpenModal }: { rows: Transaction[]; projectId: number; demo: boolean; onOpenModal: (kind: "sale" | "purchase" | "other") => void }) {
...
function TransactionRow({ item, demo, onOpenModal }: { item: Transaction; demo?: boolean; onOpenModal?: (kind: "sale" | "purchase" | "other") => void }) {
