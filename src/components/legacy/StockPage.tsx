...
export default function StockPage() {
  ...
  return (
    <>
      ...
      <ProductHistoryModal product={historyProduct} onClose={() => setHistoryProduct(null)} onChanged={() => undefined} />
    </>
  );
}
