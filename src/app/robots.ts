 ...
 * nobody's index either. So the public surface is the landing page and
 * documentation in their two languages, and everything else is declined here
 * rather than left to be discovered and then bounced.
 *
