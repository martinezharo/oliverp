...
import * as pluginRender from "@/internal/api/plugins/render";
...
const exactRoutes = new Map<string, LegacyModule>([
  ...
  ["/api/plugins/render", pluginRender], ["/api/plugins/resolve", pluginResolve], ["/api/products/create", productCreate], ["/api/projects/create", projectCreate], ["/api/projects/delete", projectDelete], ["/api/purchases/create", purchaseCreate], ["/api/purchases/get", purchaseGet], ["/api/purchases/update", purchaseUpdate],
