...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/app/ajustes", destination: "/app/settings", permanent: true },
      { source: "/es/app/ajustes", destination: "/es/app/settings", permanent: true },
      { source: "/app/transacciones", destination: "/app/transactions", permanent: true },
      { source: "/es/app/transacciones", destination: "/es/app/transactions", permanent: true },
      { source: "/app/historial", destination: "/app/history", permanent: true },
      { source: "/es/app/historial", destination: "/es/app/history", permanent: true },
